...
import com.erdemserhat.romote.database.notification.NotificationDao
import com.erdemserhat.romote.database.notification.NotificationDaoImpl
...
fun DBNotificationEntity.toNotification():Notification{
    return Notification(
        id, userId, title, content, isRead, timeStamp
    )
}