...
object DBEnneagramTestResultsTable : Table<DBEnneagramTestResultsEntity>("enneagram_test_results") {
    ...
    val dominantTypeScore =int("dominant_type_score").bindTo { it.dominantTypeScore }
    val wingTypeScore = int("wing_type_score").bindTo { it.wingTypeScore }
    val wingType= int("wing_type").bindTo { it.wingType}
...
interface DBEnneagramTestResultsEntity : Entity<DBEnneagramTestResultsEntity> {
    ...
    val wingType:Int
    val wingTypeScore:Int
    val dominantTypeScore:Int
...
data class EnneagramTestResultDto(
    ...
    val dominantTypeScore: Int =11,
    val wingTypeScore: Int =12,
    val wingType: Int=13,
...
fun DBEnneagramTestResultsEntity.toDto(): EnneagramTestResultDto {
    return EnneagramTestResultDto(
        ...
        dominantTypeScore = this.dominantTypeScore,
        wingType = this.wingType,
        wingTypeScore = this.wingTypeScore,
        createdAt = createdAt
    )
